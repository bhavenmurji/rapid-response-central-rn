  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <MaterialIcons name="school" size={32} color={EmergencyColors.white} />
        <Text style={styles.headerTitle}>FamMed Central</Text>
        <Text style={styles.headerSubtitle}>Medical education and study tools</Text>
      </View>
      <View style={styles.content}>
        <Text style={styles.comingSoon}>Coming Soon</Text>
        <Text style={styles.description}>Medical education content, study materials, and AI-assisted learning</Text>
      </View>
    </SafeAreaView>
  );
}
